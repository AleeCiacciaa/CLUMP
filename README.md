...
This project contains a set of Python scripts developed to analyse observational data related to the study of clumps 124103 and its five kers. The program makes it possible to calculate emission moments, filter data according to frequency intervals, select regions of interest and produce visual and numerical output.
...
- **user_interface**: script used to simplify the readability of the program by dividing it into sections according to the type of analysis desired:
    ...
    - [5] Reading table: to be able to read the columns in the table for a certain clump,  
      ...
      opening the document. This is the only part of the program that can be done by  
