...
if __name__ == "__main__":
    ...
    momentumn(config.cube_fits, config.freq_min, config.freq_max, config.c, config.nu_rest, config.moment0_fits, config.moment1_fits, config.moment2_fits, config.sliced_cube_fits)
